...
Officially tested languages are English (en), German (de) and French (fr). Other languages might have some rendering quirks due to differing Wiktionary styles.
